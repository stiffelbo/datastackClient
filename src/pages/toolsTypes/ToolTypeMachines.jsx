...
const ToolTypeMachines = ({ id = null, data = {}, rwd = defaultRwd }) => {
  ...
  const handleAdd = useCallback(
    async ({ mappedItemData, prevElementData }) => {
      ...
      // 🔑 payload zgodny ze schematem ToolTypeMachiness
      const payload = {
        tool_type_id: id,
      ...
      try {
        ...
        console.error('Error creating ToolTypeMachines row', e);
      }
    },
  ...
  return (
    ...
    >
      <Mapper
        entityName='ToolTypeMachinesMapper'
        ownerLabel="Maszyny Typu Narzedzi"
        owner={{ id }}
...
export default ToolTypeMachines;
