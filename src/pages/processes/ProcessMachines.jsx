...
const ProcessMachines = ({ id = null, data = {}, rwd = defaultRwd }) => {
  ...
  const assignedEntity = useEntity({
    endpoint: '/processes_machines/',
    entityName: 'ProcessesMachines',
    query: { process_id: id },
  });
  ...
  return (
    ...
    >
      <Mapper
        entityName='ProcessesMachinesMapper'
        ownerLabel="Maszyny Procesu"
        owner={{ id }}
...
export default ProcessMachines;
