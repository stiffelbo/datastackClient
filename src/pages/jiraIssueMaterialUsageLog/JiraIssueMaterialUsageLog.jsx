...
const entityName = 'JiraIssueMaterialUsageLog';
const endpoint = '/jira_issue_material_usage_log/';
...
const JiraIssueMaterialUsageLog = () => {
...
export default JiraIssueMaterialUsageLog;
